...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		if(robotXLocation>699 && robotXLocation<751 && robotYLocation>349 && robotYLocation<451) {
		...
		if(robotYLocation>499) {
		JOptionPane.showMessageDialog(null, "Find the impaled eye");	
		
		}
		if(robotYLocation<199 && robotXLocation <349) {
			treasureFound();
		}
